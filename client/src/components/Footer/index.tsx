  ...
  return (
    <>
      <div className="relative flex justify-start md:justify-center md:items-end ">
        <img
          className="absolute z-0 object-cover w-full h-full top-10 xl:mt-10"
          src="https://i.ibb.co/RYTXrBR/footer-5-marketing-background.png"
          alt="background"
        />
        <div className="relative z-10 flex flex-col items-start justify-start px-4 pt-36 md:pt-32 lg:pt-40 xl:pt-96 md:px-6 xl:px-20 md:justify-center md:items-center">
          <div className="flex flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
            <div className="flex items-center justify-start space-x-4">
              ...
              <p className="text-xl font-semibold leading-normal text-white w-60 xl:text-2xl">
                Suluhisho-RH
              </p>
            </div>
          ...
          <div className="flex flex-col-reverse items-center w-full mt-12 xl:justify-between xl:flex-row xl:items-start ">
            <p className="mt-10 text-sm leading-none text-white md:mt-12 xl:mt-0">
              2022 Suluhisho-HR.Tous les droits sont réservés
            </p>
            <div className="flex flex-col items-start justify-start w-full mt-10 space-y-4 md:mt-12 xl:mt-0 md:flex-row md:justify-center md:w-auto md:space-y-0 md:items-center md:space-x-4 xl:space-x-6">
            ...
            <div className="flex items-start justify-start w-full space-x-6 md:justify-end md:w-auto md:items-center ">
